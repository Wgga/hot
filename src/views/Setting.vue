	...
	<div class="setting">
		...
		<n-card class="set-item">
			<div class="top">
				...
				<n-select class="set" v-model:value="siteTheme" :options="themeOptions"
		...
		<n-card class="set-item">
			<div class="top" style="flex-direction: column; align-items: flex-start">
				<div class="name">
					...
					<n-card class="tip" :style="{ backgroundColor: 'var(--n-border-color)', margin: '12px 0' }">
				...
				<n-slider v-model:value="listFontSize" :tooltip="false" :max="20" :min="14" :step="0.01"
					:marks="{ 14: '默认', 16: '大一点', 20: '最大', }" />
			</div>
		</n-card>
		<n-card class="set-item">
			<div class="top">
